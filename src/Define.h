...
#define GAMEOVER_PLAY_X 160
#define GAMEOVER_PLAY_Y 270
#define GAMEOVER_PLAY_WIDTH 165
#define GAMEOVER_PLAY_HEIGHT 35
#define GAMEOVER_QUIT_X 210
#define GAMEOVER_QUIT_Y 360
